    ...
    <div className="flex flex-col">
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          ...
          {/* Daily Wellness Quote - science-based */}
          <div className="mt-12 max-w-4xl mx-auto">
            <div className="text-center mb-8">
              <h2 className="text-[#2D68C4] font-medium mb-2">
                {t('quote.title')}
              </h2>
              <h2 className="text-[#1C1C1E] text-2xl md:text-3xl font-bold mb-4">
                {t('quote.heading')}
              </h2>
              <p className="text-[#606060] max-w-2xl mx-auto">
                {t('quote.subheading')}
          ...
          {/* Premium membership promotion - science-based */}
          <div className="mt-16 max-w-4xl mx-auto">
            <div className="bg-white rounded-xl p-6 md:p-8 border border-[#D1C7B7]/30 shadow-lg relative overflow-hidden">
              {/* Subtle decorative elements */}
              <div className="absolute top-0 left-0 w-full h-full">
                <div className="absolute top-1/4 right-1/4 w-32 h-32 bg-[#2D68C4]/5 rounded-lg blur-xl"></div>
                <div className="absolute bottom-1/3 left-1/3 w-40 h-40 bg-[#4C9F70]/5 rounded-lg blur-xl"></div>
              </div>
              ...
              <div className="relative">
                <div className="flex flex-col md:flex-row gap-8">
                  ...
                  <div className="flex-1">
                    <div className="inline-flex items-center gap-1.5 bg-[#2D68C4]/10 text-[#2D68C4] px-3 py-1.5 rounded-full text-xs font-medium mb-4">
                      <ActivitySquare className="h-3.5 w-3.5" />
                      <span>{t('premium.badge')}</span>
                    </div>
                    
                    <h3 className="text-2xl md:text-3xl font-bold mb-4 text-[#1C1C1E]">{t('premium.title')}</h3>
                    ...
                    <div className="space-y-3 mb-6">
                      <div className="flex items-start gap-2">
                        <CheckCircle2 className="h-5 w-5 text-[#4C9F70] flex-shrink-0 mt-0.5" />
                        <span className="text-[#1C1C1E]">{t('premium.benefit1')}</span>
                      </div>
                      <div className="flex items-start gap-2">
                        <CheckCircle2 className="h-5 w-5 text-[#4C9F70] flex-shrink-0 mt-0.5" />
                        <span className="text-[#1C1C1E]">{t('premium.benefit2')}</span>
                      </div>
                      <div className="flex items-start gap-2">
                        <CheckCircle2 className="h-5 w-5 text-[#4C9F70] flex-shrink-0 mt-0.5" />
                        <span className="text-[#1C1C1E]">{t('premium.benefit3')}</span>
                      </div>
                    </div>
                    ...
                    <Button 
                      size="lg" 
                      asChild 
                      className="bg-[#2D68C4] hover:bg-[#2D68C4]/90 text-white shadow-sm hover:shadow-md transition-all hover:scale-[1.01]"
                  ...
                  <div className="md:w-64 flex-shrink-0">
                    <div className="bg-[#F8F7F4] rounded-lg p-5 border border-[#D1C7B7]/30 shadow-sm">
                      <h4 className="text-lg font-bold mb-1 text-[#1C1C1E]">{t('premium.plan.title')}</h4>
                      <div className="mb-4">
                        <span className="text-3xl font-bold text-[#2D68C4]">$9.99</span>
                        <span className="text-[#606060]">{t('premium.plan.period')}</span>
                      </div>
                      <ul className="space-y-2 mb-5">
                        <li className="flex items-center gap-2 text-sm">
                          <CheckCircle2 className="h-4 w-4 text-[#4C9F70]" />
                          <span className="text-[#1C1C1E]">{t('premium.plan.feature1')}</span>
                        </li>
                        <li className="flex items-center gap-2 text-sm">
                          <CheckCircle2 className="h-4 w-4 text-[#4C9F70]" />
                          <span className="text-[#1C1C1E]">{t('premium.plan.feature2')}</span>
                        </li>
                        <li className="flex items-center gap-2 text-sm">
                          <CheckCircle2 className="h-4 w-4 text-[#4C9F70]" />
                          <span className="text-[#1C1C1E]">{t('premium.plan.feature3')}</span>
                        </li>
                      </ul>
                      <Button 
                        asChild 
                        variant="outline" 
                        className="w-full border-[#2D68C4]/30 text-[#2D68C4] hover:bg-[#2D68C4]/5 hover:border-[#2D68C4] transition-all"
          ...
          <div className="flex justify-center mt-12">
            <Button variant="outline" size="lg" asChild className="border-[#2D68C4]/30 text-[#2D68C4] hover:bg-[#2D68C4]/5 hover:border-[#2D68C4]">
              <Link href="/science">
      ...
      {/* Elements & Health - science-based */}
      <section className="py-16 md:py-24 bg-[#F8F7F4]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-[#4C9F70] font-medium mb-2">
              {t('elements.title')}
            </h2>
            <h2 className="text-[#1C1C1E] text-3xl md:text-4xl font-bold mb-4">
              {t('elements.heading')}
          ...
          <div className="flex justify-center mb-6">
            <Link href="/elements" className="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-[#4C9F70]/10 hover:bg-[#4C9F70]/20 text-[#4C9F70] transition-colors">
            ...
            <TabsContent value="fire">
              <Card className="border-red-500/30">
                <CardHeader className="px-4 sm:px-6 py-4 sm:py-6">
                  <CardTitle className="flex items-center gap-2 text-base sm:text-lg md:text-xl flex-wrap text-[#1C1C1E]">
                  ...
                  <CardDescription className="text-xs sm:text-sm mt-1 text-[#606060]">
                    Dynamic, energetic, and passionate
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div>
                    <h4 className="font-medium mb-2 text-[#1C1C1E]">Health Tendencies</h4>
                    <ul className="grid grid-cols-1 md:grid-cols-2 gap-2">
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="h-5 w-5 text-[#4C9F70] flex-shrink-0 mt-0.5" />
                        <span className="text-[#1C1C1E]">High metabolic rate and natural vitality</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="h-5 w-5 text-[#4C9F70] flex-shrink-0 mt-0.5" />
                        <span className="text-[#1C1C1E]">Quick recovery from illness</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="h-5 w-5 text-[#4C9F70] flex-shrink-0 mt-0.5" />
                        <span className="text-[#1C1C1E]">Tendency toward inflammation</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="h-5 w-5 text-[#4C9F70] flex-shrink-0 mt-0.5" />
                        <span className="text-[#1C1C1E]">Risk of burnout when overextended</span>
                      </li>
                    </ul>
                  </div>
                  
                  <div>
                    <h4 className="font-medium mb-2 text-[#1C1C1E]">Wellness Recommendations</h4>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="bg-white p-4 rounded-lg text-center border border-[#D1C7B7]/30 shadow-sm">
                        <h5 className="font-medium mb-1 text-[#1C1C1E]">Nutrition</h5>
                        <p className="text-sm text-[#606060]">
                          Cooling foods and anti-inflammatory herbs
                        </p>
                      </div>
                      <div className="bg-white p-4 rounded-lg text-center border border-[#D1C7B7]/30 shadow-sm">
                        <h5 className="font-medium mb-1 text-[#1C1C1E]">Movement</h5>
                        <p className="text-sm text-[#606060]">
                          High-intensity interval training balanced with recovery
                        </p>
                      </div>
                      <div className="bg-white p-4 rounded-lg text-center border border-[#D1C7B7]/30 shadow-sm">
                        <h5 className="font-medium mb-1 text-[#1C1C1E]">Balance</h5>
                        <p className="text-sm text-[#606060]">
