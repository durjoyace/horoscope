      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="flex items-center bg-gradient-to-r from-purple-600 to-indigo-600 p-4 rounded-lg shadow-lg">
              ...
              <p className="text-white font-medium">Evidence-based recommendations</p>
            </div>
          </div>
        </div>
      </div>
