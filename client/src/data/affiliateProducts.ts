...
export const affiliateProducts: AffiliateProduct[] = [
  ...
  {
    id: "prod-039",
    name: "Babylist Baby Registry Wellness Box",
    description: "Curated wellness box for new parents with organic teas, bath salts, and self-care essentials.",
    price: 75.00,
    imageUrl: "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=400",
    category: "selfcare",
    rating: 4.7,
    recommendedSigns: ["cancer", "pisces", "taurus", "virgo"],
    affiliateUrl: "https://babylist.com"
  },
  {
    id: "prod-040",
